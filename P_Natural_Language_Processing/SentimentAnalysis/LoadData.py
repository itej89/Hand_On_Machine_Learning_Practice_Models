...
class LoadData_TFDS():
    ...
    def load_Data_TFDS_GetInfo(self, name, data_dir, tuple_format = True, Split=None):
        import tensorflow_datasets as tfds
        dataset, tfds_info = tfds.load(name=name, data_dir=data_dir, download=False, as_supervised = tuple_format, split =Split, with_info=True)
        return tfds_info
