...
class MODEL_PATH_CONSTANTS:
    MODEL_GRAPH_DIR = "model_graph"
    MODEL_GRAPH = "iris_tree.dot"
    DIR = "checkpoints"
    ...
    @staticmethod
    def GetModelGraphPath():
        import os
        return os.path.join(MODEL_PATH_CONSTANTS.GetRootDirectory(), MODEL_PATH_CONSTANTS.MODEL_GRAPH_DIR, MODEL_PATH_CONSTANTS.MODEL_GRAPH)
