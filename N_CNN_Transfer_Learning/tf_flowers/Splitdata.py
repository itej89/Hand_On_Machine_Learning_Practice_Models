...
if __name__ == '__main__':
    ...
    dataset_train = objLoadData.load_Data_TFDS("mnist", DATASET_PATH_CONSTANTS.GetDirectoryPath(), True, "train")
    dataset_test = objLoadData.load_Data_TFDS("mnist", DATASET_PATH_CONSTANTS.GetDirectoryPath(), True, "test")
