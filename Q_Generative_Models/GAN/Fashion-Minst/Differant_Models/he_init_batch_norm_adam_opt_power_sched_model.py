...
class fashion_mnist_model :
    ...
    def fit_model(self, train_X, train_y, X_valid, y_valid, checkpoint_path=None, model_param_path=None, no_epochs=30, batch_size=250, initial_epoch = 0, verbosity=1, get_model = False):
        ...
        from Powe_Sched_Params import Powe_Sched_Params
        model_params = Powe_Sched_Params() 
        ...
        from calbakLearningRatePowerSchedulerPerEpoch import calbakLearningRatePowerSchedulerPerEpoch
        lr_decay_callback = calbakLearningRatePowerSchedulerPerEpoch(model_params, None)
