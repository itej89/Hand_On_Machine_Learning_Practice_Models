...
# fmnist_model.fit_model(fmnist_model.Build_GAN, train_dataset , CheckPointPath, ModleParamtPath, 30, Total_Epochs, Batch_Size, Initiate_at_Epoch, 1)


reconstructions = fmnist_model.model_reconstruct(CheckPointPath ,50)

from PlotData import PlotData
objPlotData = PlotData()
objPlotData.shaow_images(reconstructions, 50)
