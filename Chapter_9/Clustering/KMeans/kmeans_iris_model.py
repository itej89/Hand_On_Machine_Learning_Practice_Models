...
class kmeans_iris_model :
    ...
    def build_mini_batch_model(self, cluster_count = 3):
        from sklearn.cluster import MiniBatchKMeans
        kmeans = MiniBatchKMeans(n_clusters=cluster_count)
        return kmeans


    def fit_model(self, model, train_X):
...
iris_model = kmeans_iris_model.build_model(cluster_count=3)

iris_model = kmeans_iris_model.fit_model(iris_model, train_x)

kmeans_iris_model.print_model_params(iris_model, 3, train_x)
